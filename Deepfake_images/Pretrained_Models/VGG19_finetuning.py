...
# 🔹 Load model
vgg19_base = load_pretrained_models("vgg19")
...
callbacks = [
    ...
    ModelCheckpoint(
        filepath=os.path.join(SAVE_DIR, "best_vgg19.keras"),
...
model.save(os.path.join(SAVE_DIR, "vgg19_final.keras"))
model.save(os.path.join(SAVE_DIR, "vgg19_final.h5"))
